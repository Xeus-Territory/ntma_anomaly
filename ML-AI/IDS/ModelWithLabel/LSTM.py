...
# @This code from https://github.com/GYXGY/Anomaly-Detection
# @Just modified for alternative version of pandas like .as_matrix() into .values
...
dataroot="..\..\Data\CIC-IDS2017\MachineLearningCSV\MachineLearningCVE\Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv"
...
x_train, x_test, y_train,y_test = train_test_split(df.iloc[:,0:-1].values, df[' Label'].values, test_size=0.3, random_state=42)
